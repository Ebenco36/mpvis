...
const CFormCheck = vue.defineComponent({
    ...
    setup(props, { attrs, emit, slots }) {
        ...
        const formLabel = () => props.button
            ...
            : vue.h(CFormLabel, { class: 'form-check-label', ...(props.id && { for: props.id }) }, {
                default: () => (slots.label && slots.label()) || props.label,
            });
        const formValidation = () => {
            return vue.h(CFormControlValidation, {
...
const CNavbarBrand = vue.defineComponent({
    ...
    setup(props, { slots }) {
        return () => vue.h(props.component ?? (props.href ? 'a' : 'span'), {
            class: 'navbar-brand',
            href: props.href,
        }, slots.default && slots.default());
    },
...
const CTable = vue.defineComponent({
    ...
    setup(props, { slots, attrs }) {
        const columnNames = vue.computed(() => getColumnNames(props.columns, props.items));
        //   props.columns
