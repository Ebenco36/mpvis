...
<script>
import AngularImg from '@/pages/assets/images/angular.jpg'
import ReactImg from '@/pages/assets/images/react.jpg'
import VueImg from '@/pages/assets/images/vue.jpg'
export default {
  name: 'Carousels',
  setup() {
    return {
